...
export default function App() {
  ...
  /**
   * @description should be disconnected from the current Phantom wallet instance
  ...
  const disconnectWallet = async () => {
    ...
    if (solana) {
      try {
				// disconnect the current to the wallet
  ...
  return (
    <div className="App">
      {provider && walletKey && (
        // Display the Disconnect button when connected to a wallet key
